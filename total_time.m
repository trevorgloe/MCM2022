...
Cd = biker.A*rho*0.5;     % drag coefficient

Crr = 0.001;            % tyre rolling resistance
Cs = 0.01;             % scrubbing coefficient
...
time_calc_params.rw = 0.2;      % [m] wheel radius
...
[tout data] = ode45(@(t,s)advance_vp(t,s,time_calc_params),[0 Tf(end)],ic);
